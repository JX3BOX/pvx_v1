            ...
            <div class="m-info__scroll">
                ...
                <div class="m-info__bottom">
                    ...
                    <template v-for="(item, index) in exteriorDetail.meta.img_urls">
                        <img class="u-exterior" :key="index" v-if="item.indexOf('详情') > -1" :src="getImgPath(item)" />
                    </template>
                    <div class="m-info__title">
                        <div class="u-line"></div>
            ...
            <div class="m-quick">
                ...
                <div class="u-action u-bag" @click="userEntWarehouse">
                    <div class="m-img__pr">
                        ...
                        <img class="u-img u-img__hover" src="@/assets/img/exterior/icon/solar_inbox-in-bold_act.svg" />
                    </div>
                </div>
                ...
                <div class="u-action u-unfold" @click="openNewDetail">
                    <div class="m-img__pr">
                        ...
                        <img class="u-img u-img__hover" src="@/assets/img/exterior/icon/icomoon-free_new-tab_act.svg" />
                    </div>
                </div>
            </div>
